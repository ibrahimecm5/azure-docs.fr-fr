---
title: Configurer les conditions de correspondance des règles Azure Front Door
description: Cet article fournit une liste des différentes conditions de correspondance disponibles avec les règles Azure Front Door.
services: frontdoor
author: duongau
...
ms.locfileid: "132324905"
---
# <a name="azure-front-door-rules-match-conditions"></a>Conditions de correspondance des règles Azure Front Door

Dans le [moteur de règles](front-door-rules-engine.md) d’Azure Front Door et l’[ensemble de règles](standard-premium/concept-rule-set.md) Standard/Premium d’Azure Front Door, une règle se compose d’aucune ou d’un nombre quelconque de conditions de correspondance et d’une action. Cet article fournit une description détaillée des conditions de correspondance que vous pouvez utiliser dans un ensemble de règles ou moteur de règles Azure Front Door.
...
:::image type="content" source="./media/rules-match-conditions/device-type.png" alt-text="Capture d’écran du portail montrant la condition de correspondance device type.":::
...
:::image type="content" source="./media/rules-match-conditions/post-args.png" alt-text="Capture d’écran du portail montrant la condition de correspondance post args.":::
...
:::image type="content" source="./media/rules-match-conditions/query-string.png" alt-text="Capture d’écran du portail montrant la condition de correspondance query string.":::
...
:::image type="content" source="./media/rules-match-conditions/remote-address.png" alt-text="Capture d’écran du portail montrant la condition de correspondance remote address.":::
...
:::image type="content" source="./media/rules-match-conditions/request-body.png" alt-text="Capture d’écran du portail montrant la condition de correspondance request body.":::
...
:::image type="content" source="./media/rules-match-conditions/request-file-name.png" alt-text="Capture d’écran du portail montrant la condition de correspondance request file name.":::
...
:::image type="content" source="./media/rules-match-conditions/request-file-extension.png" alt-text="Capture d’écran du portail montrant la condition de correspondance request file extension.":::
...
:::image type="content" source="./media/rules-match-conditions/request-header.png" alt-text="Capture d’écran du portail montrant la condition de correspondance request header.":::
...
:::image type="content" source="./media/rules-match-conditions/request-method.png" alt-text="Capture d’écran du portail montrant la condition de correspondance request method.":::
...
:::image type="content" source="./media/rules-match-conditions/request-path.png" alt-text="Capture d’écran du portail montrant la condition de correspondance request path.":::
...
:::image type="content" source="./media/rules-match-conditions/request-protocol.png" alt-text="Capture d’écran du portail montrant la condition de correspondance request protocol.":::
...
:::image type="content" source="./media/rules-match-conditions/request-url.png" alt-text="Capture d’écran du portail montrant la condition de correspondance request URL.":::
...
## <a name="operator-list"></a>Liste d'opérateurs
...
* Découvrez-en plus sur l’[ensemble de règles Azure Front Door Standard/Premium](standard-premium/concept-rule-set.md).
* Découvrez comment [configurer votre premier ensemble de règles](standard-premium/how-to-configure-rule-set.md).
* En savoir plus sur les [actions d’un ensemble de règles](standard-premium/concept-rule-set-actions.md).

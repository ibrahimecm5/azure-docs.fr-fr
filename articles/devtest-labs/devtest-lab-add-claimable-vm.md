---
title: Créer et gérer des machines virtuelles revendicables
...
1. Sélectionnez **Tous les services**, puis **DevTest Labs** dans la section **DEVOPS**. Si vous sélectionnez * (étoile) à côté de **DevTest Labs** dans la section **DEVOPS**, cette action ajoute **DevTest Labs** au menu de navigation de gauche afin que vous puissiez y accéder facilement la prochaine fois. Vous pouvez ensuite sélectionner **DevTest Labs** dans le menu de navigation de gauche.
    ...
    ![Capture d’écran montrant Tous les services : sélectionnez DevTest Labs.](./media/devtest-lab-create-lab/all-services-select.png)
...
2. Dans la page **Vue d’ensemble** du laboratoire, sélectionnez **+ Ajouter**.
    ...
    ![Capture d’écran montrant le bouton Ajouter une machine virtuelle.](./media/devtest-lab-add-vm/devtestlab-home-blade-add-vm.png)
...
1. Sur l’onglet **Paramètres de base** de la page **Machine virtuelle**, effectuez les actions suivantes :
    ...
    >[!NOTE] 
    >Si vous n’êtes pas familier avec DevTest Labs ou avec la configuration d’artefacts, reportez-vous à la section [Ajouter des artefacts après l’installation](./devtest-lab-add-vm.md#add-artifacts-after-installation), puis reprenez la procédure à ce stade.
...
## <a name="use-a-claimable-vm"></a>Utiliser une machine virtuelle revendicable
...
* Dans la liste des **machines virtuelles revendicables**, en bas du volet **Vue d’ensemble** du laboratoire, cliquez avec le bouton droit sur une des machines virtuelles, puis choisissez **Revendiquer la machine**.
  ...
  ![Capture d’écran montrant la demande d’une machine virtuelle revendicable spécifique.](./media/devtest-lab-add-vm/devtestlab-claim-VM.png)
...
* En haut du volet **Vue d’ensemble**, choisissez **Revendiquer n’importe laquelle**. Une machine virtuelle aléatoire est attribuée dans la liste des machines virtuelles qui peuvent être revendiquées.
  ...
  ![Capture d’écran montrant la demande d’une machine virtuelle revendicable.](./media/devtest-lab-add-vm/devtestlab-claim-any.png)
...
- Dans la liste **Mes machines virtuelles**, cliquez avec le bouton droit sur l’une des machines virtuelles (ou sélectionnez ses points de suspension ( **...** )), puis choisissez **Cesser de revendiquer**.
  ...
  ![Capture d’écran montrant l’arrêt de la revendication d’une machine virtuelle dans la liste.](./media/devtest-lab-add-vm/devtestlab-unclaim-VM2.png)
...
- Dans la liste **Mes machines virtuelles**, sélectionnez une machine virtuelle pour ouvrir son volet de gestion, puis sélectionnez **Cesser de revendiquer** dans la barre de menus supérieure.
  ...
  ![Capture d’écran montrant l’arrêt de la revendication d’une machine virtuelle dans le volet de gestion de la machine virtuelle.](./media/devtest-lab-add-vm/devtestlab-unclaim-VM.png)
...
### <a name="transfer-the-data-disk"></a>Transférer le disque de données
...
Cette action est appelée transfert du disque de données. Le disque de données devient alors disponible dans la liste **Mes disques de données** du nouvel utilisateur qui peut ainsi le gérer.

![Capture d’écran montrant l’arrêt de la revendication des disques de données.](./media/devtest-lab-add-vm/devtestlab-unclaim-datadisks.png)

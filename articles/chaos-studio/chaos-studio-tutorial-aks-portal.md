---
title: Créer une expérience qui utilise une erreur AKS Chaos Mesh à l’aide d’Azure chaos Studio avec le portail Azure
description: Créer une expérience qui utilise une erreur AKS Chaos Mesh avec le portail Azure
author: johnkemnetz
ms.topic: how-to
ms.date: 11/01/2021
ms.author: johnkem
...
ms.locfileid: "132373514"
---
# <a name="create-a-chaos-experiment-that-uses-a-chaos-mesh-fault-to-kill-aks-pods-with-the-azure-portal"></a>Créer une expérience de chaos qui utilise une erreur Chaos Mesh pour tuer des pods AKS avec le portail Azure

...
## <a name="azure-role-assignments-limit-for-management-groups"></a>Limite d’attributions de rôle Azure pour les groupes d’administration
...
De même, si vous répertoriez cette attribution de rôle à l’aide d’Azure CLI, `principalName` est vide à l’écran. Par exemple, [az role assignment list](/cli/azure/role/assignment#az_role_assignment_list) retourne une attribution de rôle similaire à ce qui suit :

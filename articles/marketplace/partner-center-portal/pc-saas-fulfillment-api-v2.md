...
> [!NOTE]
> Microsoft accorde au client une période de grâce de 30 jours avant l’annulation automatique de l’abonnement. À l’issue de la période de grâce de 30 jours, le webhook recevra une action de [désabonnement](#cancel-a-subscription).

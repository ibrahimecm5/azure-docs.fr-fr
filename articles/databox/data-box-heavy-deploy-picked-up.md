...
description: Dans ce tutoriel, découvrez comment retourner l’appareil Azure Data Box Heavy, notamment préparer l’expédition de Data Box, vérifier le chargement de données et à effacer les données.
services: databox
author: alkohli
ms.service: databox
ms.subservice: heavy

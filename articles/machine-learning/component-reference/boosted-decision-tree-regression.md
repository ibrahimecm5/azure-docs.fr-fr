---
title: 'Régression d’arbre de décision optimisé : référence du composant'
titleSuffix: Azure Machine Learning
description: Découvrez comment utiliser le composant Régression d’arbre de décision optimisé dans Azure Machine Learning pour créer un ensemble d’arbres de régression utilisant une optimisation.
...
ms.locfileid: "131566931"
---
# <a name="boosted-decision-tree-regression-component"></a>Composant Régression d’arbre de décision optimisé

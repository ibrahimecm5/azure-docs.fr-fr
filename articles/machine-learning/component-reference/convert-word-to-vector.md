...
7. Pour **Nombre minimal de mots**, indiquez un nombre minimal de mots. Le composant ignore tous les mots dont la fréquence est inférieure à cette valeur.
...
L’exemple suivant montre le fonctionnement du composant Vectoriser des mots. Il utilise le module Vectoriser des mots avec les paramètres par défaut sur le jeu de données Wikipédia SP 500 prétraité.
...
Le tableau suivant contient la sortie de ce composant obtenue en utilisant le jeu de données Wikipédia SP 500 en entrée. La colonne la plus à gauche indique le vocabulaire. Son vecteur de plongement lexical est représenté par les valeurs des colonnes restantes dans la même ligne.

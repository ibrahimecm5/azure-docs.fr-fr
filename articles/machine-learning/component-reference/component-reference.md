---
title: Référence sur les algorithmes et les composants
description: Découvrez les composants de concepteur Azure Machine Learning que vous pouvez utiliser pour créer vos propres projets d’apprentissage automatique.
...
ms.locfileid: "131566772"
---
# <a name="algorithm--component-reference-for-azure-machine-learning-designer"></a>Référence sur les algorithmes et les composants pour concepteur Azure Machine Learning

Cette référence présente le contexte technique de chacun des algorithmes et composants d’apprentissage automatique disponibles dans le concepteur Azure Machine Learning.
...
## <a name="data-preparation-components"></a>Composants de préparation de données
...
## <a name="components-for-building-and-evaluating-models"></a>Composants pour la génération et l’évaluation de modèles
...
| Langage Python | Écrivez du code et incorporez-le dans un composant pour intégrer Python avec votre pipeline. | [Créer un modèle Python](create-python-model.md) <br/> [Exécuter un script Python](execute-python-script.md) |
| Langage R | Écrivez du code et incorporez-le dans un composant pour intégrer R avec votre pipeline. | [Exécuter un script R](execute-r-script.md) |
...
| Vision par ordinateur | Composants liés au prétraitement de données d’image et à la reconnaissance d’image. |  [Appliquer une transformation d’image](apply-image-transformation.md) <br/> [Convertir en répertoire d’images](convert-to-image-directory.md) <br/> [Lancer une transformation d’image](init-image-transformation.md) <br/> [Découper un répertoire d’images](split-image-directory.md) <br/> [DenseNet](densenet.md) <br/> [ResNet](resnet.md) |
...
Découvrez les [composants de service web](web-service-input-output.md) nécessaires à l’inférence en temps réel dans le concepteur Azure Machine Learning.

## <a name="error-messages"></a>Messages d’erreur

Découvrez les [messages d’erreur et codes d’exception](designer-error-codes.md) que vous pourriez rencontrer en utilisant des composants dans le concepteur Azure Machine Learning.

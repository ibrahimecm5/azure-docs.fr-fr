---
title: 'Perceptron moyenné à deux classes : référence du composant'
titleSuffix: Azure Machine Learning
description: Découvrez comment utiliser le composant Perceptron moyenné à deux classes dans le concepteur pour créer un classifieur binaire.
...
ms.locfileid: "131566845"
---
# <a name="two-class-averaged-perceptron-component"></a>Composant Perceptron moyenné à deux classes
...
1.  Connectez un jeu de données d’entraînement et entraînez le modèle :
    ...
    + Si vous définissez **Créer un mode d’apprentissage** sur **Paramètre unique**, connectez un jeu de données balisé au composant [Effectuer l’apprentissage du composant](train-model.md).  

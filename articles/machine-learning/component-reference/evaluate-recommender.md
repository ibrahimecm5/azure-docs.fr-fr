---
title: 'Évaluer le générateur de recommandations : référence du composant'
titleSuffix: Azure Machine Learning
description: Découvrez comment utiliser le composant Évaluer le générateur de recommandations dans Azure Machine Learning pour évaluer la précision de prédictions du modèle de générateur de recommandations.

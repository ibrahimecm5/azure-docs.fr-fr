---
title: 'Machine à vecteurs de support à deux classes : référence de composant'
titleSuffix: Azure Machine Learning
description: Découvrez comment utiliser le composant Machine à vecteurs de support à deux classes dans Azure Machine Learning pour créer un classifieur binaire.
...
ms.locfileid: "131566820"
---
# <a name="two-class-support-vector-machine-component"></a>Composant Machine à vecteurs de support à deux classes

Cet article décrit un composant dans le concepteur Azure Machine Learning.

Utilisez ce composant pour créer un modèle basé sur l’algorithme de machine à vecteurs de support. 
...
Après avoir défini les paramètres de modèle, effectuez l’apprentissage du modèle en utilisant les composants de formation et en fournissant un *jeu de données avec balises* qui inclut une colonne d’étiquettes ou de résultats.
...
1.  Ajoutez le composant **Machine à vecteurs de support à deux classes** à votre pipeline.  

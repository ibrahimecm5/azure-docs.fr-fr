---
title: Utiliser le composant du générateur de recommandations Score Wide and Deep
titleSuffix: Azure Machine Learning
description: Découvrez comment utiliser le composant du générateur de recommandations Score Wide and Deep dans Azure Machine Learning pour noter les prédictions de recommandation pour un jeu de données.
...
ms.locfileid: "131566802"
---
# <a name="score-wide-and-deep-recommender"></a>Générateur de recommandations Score Wide and Deep

Cet article explique comment utiliser le composant du **générateur de recommandations Score Wide and Deep** dans le concepteur Azure Machine Learning pour créer des prédictions basées sur un modèle de recommandation formé, sur la base de la formation Wide and Deep Google.
...
Ce composant prend en charge différents types de recommandations, chacune avec des exigences différentes. Cliquez sur le lien correspondant au type de données que vous avez et au type de recommandation que vous souhaitez créer.
...
3. **Sélection d’éléments recommandés** : Indiquez si vous utilisez le composant de scoring en production ou pour l’évaluation de modèle, en choisissant l’une des valeurs suivantes :

    - **À partir d’éléments notés (pour l’évaluation du modèle)** : Sélectionnez cette option si vous développez ou testez un modèle. Cette option active le **mode d’évaluation**, le composant génère alors des recommandations uniquement à partir des éléments du jeu de données d’entrée qui ont été évalués.
    - **À partir de tous les éléments** : Sélectionnez cette option si vous configurez un essai pour une utilisation dans un service web ou en production.  Cette option active le **mode de production**, le composant émet alors des recommandations à partir de tous les éléments vus pendant l’entraînement.

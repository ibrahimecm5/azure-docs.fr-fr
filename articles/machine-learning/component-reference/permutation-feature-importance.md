---
title: 'Importance de la fonctionnalité de permutation : référence du composant'
titleSuffix: Azure Machine Learning
description: Découvrez comment utiliser le composant Importance de la fonctionnalité de permutation dans le concepteur pour calculer les scores d’importance de la fonctionnalité de permutation pour les variables de fonctionnalité.
...
Les classements fournis par le composant sont souvent différents de ceux que vous obtenez du module [Sélection de caractéristiques par filtrage](filter-based-feature-selection.md). La sélection de caractéristiques par filtrage calcule les scores *avant* la création d’un modèle. 

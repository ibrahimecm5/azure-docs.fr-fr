---
title: Référence du composant de hachage des fonctionnalités
titleSuffix: Azure Machine Learning
description: Découvrez comment caractériser des données texte à l’aide du composant de hachage des caractéristiques dans le concepteur Azure Machine Learning.
...
ms.locfileid: "131567188"
---
# <a name="feature-hashing-component-reference"></a>Référence du composant de hachage des fonctionnalités
...
La fonctionnalité de hachage des caractéristiques fournie dans ce composant se base sur le framework nimbusml. Pour plus d’informations, consultez [NgramHash (classe)](/python/api/nimbusml/nimbusml.feature_extraction.text.extractor.ngramhash?view=nimbusml-py-latest&preserve-view=true).
...
## <a name="configure-the-feature-hashing-component"></a>Configurer le composant Hachage des caractéristiques

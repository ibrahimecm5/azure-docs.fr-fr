...
2. Laissez **Étiquette** et **Type de contenu** vides pour l’instant.
...
> [!TIP]
> Découvrez plus d’informations sur la [commande export](/cli/azure/appconfig/kv#az_appconfig_kv_export).

...
- **(Recommandé)** À partir de la page des tarifs et des paramètres de Defender pour le cloud
...
### <a name="access-the-policy-from-defender-for-clouds-pricing-and-settings-page"></a>Accéder à la stratégie à partir de la page des tarifs et des paramètres de Defender pour le cloud <a name="sqlip-tenant"></a>

Dans la page des **tarifs et des paramètres** de Defender pour le cloud, sélectionnez **Protection des informations SQL**.
...
:::image type="content" source="./media/sql-information-protection-policy/pricing-settings-link-to-information-protection.png" alt-text="Accès à la stratégie de protection des informations SQL depuis la page des tarifs et des paramètres de Microsoft Defender pour le cloud.":::

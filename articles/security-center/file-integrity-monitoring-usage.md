...
description: Découvrez comment comparer les lignes de base avec l’analyse de l’intégrité des fichiers dans Microsoft Defender pour le cloud.
...
Cette rubrique explique comment activer le Monitoring d'intégrité de fichier sur les fichiers et les registres. Pour plus d’informations sur l’analyse de l'intégrité des fichiers, consultez [Analyse de l’intégrité des fichiers dans Microsoft Defender pour le cloud](file-integrity-monitoring-overview.md).
...
![Registre.](./media/file-integrity-monitoring-usage/baselines-registry.png)
...
1. À partir de la fenêtre **Ajouter le Registre Windows pour Change Tracking**, dans la zone de texte **Clé de Registre Windows**, entrez la clé de Registre suivante :
    ...
    :::image type="content" source="./media/file-integrity-monitoring-usage/baselines-add-registry.png" alt-text="Activer FIM sur un registre.":::
...
1. Créez une entrée de fichier Windows personnalisée en entrant un nom pour la classe de paramètres, en activant la récursion et en spécifiant le dossier supérieur avec un suffixe de caractère générique (*).
    ...
    :::image type="content" source="./media/file-integrity-monitoring-usage/baselines-add-file.png" alt-text="Activer FIM sur un fichier.":::
...
![Données FIM.](./media/file-integrity-monitoring-usage/baselines-data.png)

...
>[!NOTE] 
> Cet article contient des informations de référence sur toutes les versions archivées d’Azure AD 1.5.42.0 et antérieures.  Pour les versions actuelles, consultez l’[historique de publication des versions d’Azure AD Connect](reference-connect-version-history.md)
...
* Prise en charge pour l’administrateur général par le biais d’Azure AD Multi-Factor Authentication et de Privileged Identity Management dans l’Assistant d’installation.

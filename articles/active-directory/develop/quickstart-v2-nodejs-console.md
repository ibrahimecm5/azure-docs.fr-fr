...
> 
> > [Démarrage rapide : application console Node.js qui appelle une API](console-app-quickstart.md?pivots=devlang-nodejs)
> 
...
> 
> Si vous êtes un administrateur général, accédez à la page **Autorisations de l’API** et sélectionnez **Accorder le consentement administrateur pour > Enter_the_Tenant_Name_Here**

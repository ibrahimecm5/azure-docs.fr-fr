...
> [!div renderon="docs"]
> Bienvenue ! Ce n’est probablement pas la page que vous attendiez. Nous travaillons actuellement sur un correctif, mais pour le moment, veuillez utiliser le lien ci-dessous pour accéder à l’article approprié :
> 
> > [Démarrage rapide : Application Android avec connexion utilisateur](mobile-app-quickstart.md?pivots=devlang-android)
> 

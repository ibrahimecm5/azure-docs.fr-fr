...
>
> > [Démarrage rapide : Application web ASP.NET qui connecte les utilisateurs](web-app-quickstart.md?pivots=devlang-aspnet)
> 
...
> 3. Selon la version de Visual Studio, vous devrez peut-être cliquer avec le bouton de droite sur le projet > **AppModelv2-WebApp-OpenIDConnect-DotNet**, puis sélectionner **Restaurer les packages NuGet**.

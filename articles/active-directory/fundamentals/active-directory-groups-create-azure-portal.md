...
## <a name="turn-off-group-welcome-email"></a>Désactiver l’e-mail de bienvenue dans le groupe
...
- [Gérer l’accès aux applications SaaS en utilisant des groupes](../enterprise-users/groups-saasapps.md)

...
Pour rechercher l’URI de l’ID d’application, dans le portail Azure, cliquez sur **Azure Active Directory**, **Inscriptions d’applications**, ouvrez la page **Paramètres** de l’application, puis cliquez sur **Propriétés**.

...
Vérifiez que l’appareil peut accéder aux ressources Microsoft ci-dessus sous le compte système en utilisant le script [Tester la connectivité d’inscription d’appareil](/samples/azure-samples/testdeviceregconnectivity/testdeviceregconnectivity/).

...
* Blink prend en charge l’authentification unique lancée par le **fournisseur de services**.
* Blink prend en charge le provisionnement d’utilisateurs **juste-à-temps**.
* Blink prend en charge le [provisionnement automatisé des utilisateurs](blink-provisioning-tutorial.md).
...
## <a name="configure-and-test-azure-ad-sso-for-blink"></a>Configurer et tester l’authentification unique Azure AD pour Blink
...
Pour configurer et tester l’authentification unique Azure AD avec Blink, effectuez les étapes suivantes :
...
1. Dans la page d’intégration de l’application **Blink** du portail Azure, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
Blink prend également en charge le provisionnement automatique des utilisateurs. Vous trouverez [ici](./blink-provisioning-tutorial.md) plus d’informations sur la façon de configurer le provisionnement automatique des utilisateurs.

## <a name="test-sso"></a>Tester l’authentification unique (SSO)

Dans cette section, vous allez tester votre configuration de l’authentification unique Azure AD avec les options suivantes.

* Cliquez sur Tester cette application dans le portail Azure. Vous êtes alors redirigé vers l’URL de connexion à Blink, d’où vous pouvez lancer le flux de connexion.

* Accédez directement à l’URL de connexion à Blink et lancez le flux de connexion.

* Vous pouvez utiliser Mes applications de Microsoft. Un clic sur la vignette Blink dans Mes applications vous redirige vers l’URL de connexion à Blink. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Étapes suivantes

Après avoir configuré Blink, vous pouvez appliquer le contrôle de session, qui protège contre l’exfiltration et l’infiltration des données sensibles de votre organisation en temps réel. Le contrôle de session est étendu à partir de l’accès conditionnel. [Découvrez comment appliquer un contrôle de session avec Microsoft Defender for Cloud Apps](/cloud-app-security/proxy-deployment-aad).

...
## <a name="add-exponenthr-from-the-gallery"></a>Ajouter ExponentHR à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-exponenthr"></a>Configurer et tester l’authentification unique Azure AD pour ExponentHR
...
Pour configurer et tester l’authentification unique Azure AD avec ExponentHR, procédez comme suit :
...
1. Dans le Portail Azure, accédez à la page d’intégration de l’application **ExponentHR**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
1. Dans la section **Configuration SAML de base**, effectuez l’étape suivante :
    ...
    Dans la zone de texte **URL de connexion**, tapez l’URL : `https://www.exponenthr.com/service/saml/login.aspx`
...
* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL de connexion ExponentHR à partir de laquelle vous pouvez lancer le flux de connexion. 

* Accédez directement à l’URL de connexion ExponentHR pour démarrer le flux de connexion.

* Vous pouvez utiliser Mes applications de Microsoft. Quand vous cliquez sur la mosaïque ExponentHR dans Mes applications, une redirection est effectuée vers l’URL de connexion à ExponentHR. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).

## <a name="next-steps"></a>Étapes suivantes

Une fois que vous avez configuré ExponentHR, vous pouvez appliquer le contrôle de session, qui protège contre l’exfiltration et l’infiltration des données sensibles de votre organisation en temps réel. Le contrôle de session est étendu à partir de l’accès conditionnel. [Découvrez comment appliquer un contrôle de session avec Microsoft Defender for Cloud Apps](/cloud-app-security/proxy-deployment-aad).

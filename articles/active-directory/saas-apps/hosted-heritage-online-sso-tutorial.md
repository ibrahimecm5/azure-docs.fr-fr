---
title: 'Tutoriel : Intégration de l’authentification unique Azure AD à Hosted Heritage Online SSO'
...
ms.locfileid: "132295717"
---
# <a name="tutorial-azure-ad-sso-integration-with-hosted-heritage-online-sso"></a>Tutoriel : Intégration de l’authentification unique Azure AD à Hosted Heritage Online SSO
...
## <a name="add-hosted-heritage-online-sso-from-the-gallery"></a>Ajouter Hosted Heritage Online SSO à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-hosted-heritage-online-sso"></a>Configurer et tester l’authentification unique Azure AD pour Hosted Heritage Online SSO
...
Pour configurer et tester l’authentification unique Azure AD avec Hosted Heritage Online SSO, effectuez les étapes suivantes :
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **Hosted Heritage Online SSO**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
1. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    a. Dans la zone de texte **Identificateur (ID d’entité)** , saisissez une URL au format suivant : `https://<SUBDOMAIN>.cirqahosting.com/shibboleth`

    b. Dans la zone de texte **URL de connexion**, saisissez une URL au format suivant : `https://<SUBDOMAIN>.cirqahosting.com/Shibboleth.sso/Login`
...
* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL d’authentification de Hosted Heritage Online SSO, à partir de laquelle vous pouvez lancer le processus de connexion. 

* Accédez directement à l’URL d’authentification de Hosted Heritage Online SSO pour lancer le processus de connexion.

* Vous pouvez utiliser Mes applications de Microsoft. Quand vous cliquez sur la vignette Hosted Heritage Online SSO dans Mes applications, vous êtes redirigé vers l’URL d’authentification de Hosted Heritage Online SSO. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Étapes suivantes

Après avoir configuré Hosted Heritage Online SSO, vous pouvez appliquer le contrôle de session, qui protège contre l’exfiltration et l’infiltration des données sensibles de votre organisation en temps réel. Le contrôle de session est étendu à partir de l’accès conditionnel. [Découvrez comment appliquer un contrôle de session avec Microsoft Defender for Cloud Apps](/cloud-app-security/proxy-deployment-aad).

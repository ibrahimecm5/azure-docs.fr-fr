...
1. Dans la page d’intégration de l’application **Freshservice** du portail Azure, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
1. Dans **Sécurité**, cliquez sur **Accéder à la sécurité Freshservice 360**.
...
* Cliquez sur **Tester cette application** dans le portail Azure. Cette opération redirige vers l’URL d’authentification Freshservice, où vous pouvez lancer le processus de connexion. 

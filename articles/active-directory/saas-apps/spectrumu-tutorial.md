...
* SpectrumU prend en charge l’approvisionnement d’utilisateurs **Juste-à-temps**.

> [!NOTE]
> L’identificateur de cette application étant une valeur de chaîne fixe, une seule instance peut être configurée dans un locataire.

## <a name="add-spectrumu-from-the-gallery"></a>Ajouter Spectrum à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-spectrumu"></a>Configurer et tester l’authentification unique (SSO) Azure AD pour SpectrumU
...
Pour configurer et tester l’authentification unique Azure AD avec SpectrumU, procédez comme suit :
...
1. Sur le Portail Azure, dans la page d’intégration de l’application **SpectrumU**, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
1. Dans la section **Configuration SAML de base**, effectuez l’étape suivante :
    ...
    Dans la zone de texte **URL de connexion**, tapez l’URL : `https://watch.spectrum.net/domainsearch/`
...
* Cliquez sur **Tester cette application** dans le portail Azure. Une redirection est effectuée vers l’URL de connexion SpectrumU, d’où vous pouvez lancer le flux de connexion. 

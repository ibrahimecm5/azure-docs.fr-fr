...
* askSpoke prend en charge l’authentification unique lancée par le **fournisseur de services et le fournisseur d’identité**.
* askSpoke prend en charge le provisionnement d’utilisateurs **juste-à-temps**.
* askSpoke prend en charge le [provisionnement d’utilisateurs automatisé](askspoke-provisioning-tutorial.md).

> [!NOTE]
> L’identificateur de cette application étant une valeur de chaîne fixe, une seule instance peut être configurée dans un locataire.

## <a name="add-askspoke-from-the-gallery"></a>Ajouter askSpoke depuis la galerie
...
Pour configurer et tester l’authentification unique Azure AD avec askSpoke, vous devez effectuer les étapes suivantes :
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **askSpoke**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
1. Cliquez sur l’onglet **Settings** dans le volet de navigation de gauche.
    ...
    ![askSpoke - Onglet Settings (Paramètres)](./media/askspoke-tutorial/configure-1.png)

1. Faites défiler jusqu’à **SSO**, puis cliquez sur **Connect**.

    ![askSpoke - Connect (Connecter)](./media/askspoke-tutorial/configure-2.png)

1. Dans la section **Enable SAML & SCIM**, effectuez les étapes suivantes :

    ![askSpoke - Section Enable SAML & SCIM (Activer SAML et SCIM)](./media/askspoke-tutorial/configure-3.png)
...
askSpoke prend également en charge le provisionnement automatique d’utilisateurs ; vous trouverez plus d’informations [ici](./askspoke-provisioning-tutorial.md) sur la façon de configurer ce dernier.
...
* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL de connexion à askSpoke, d’où vous pouvez lancer le flux de connexion.  

* Accédez directement à l’URL de connexion à askSpoke pour lancer le flux de connexion.

#### <a name="idp-initiated"></a>Lancée par le fournisseur d’identité :

* Dans le portail Azure, cliquez sur **Tester cette application** afin d’être connecté automatiquement à l’instance askSpoke pour laquelle vous avez configuré l’authentification unique. 

Vous pouvez aussi utiliser Mes applications de Microsoft pour tester l’application dans n’importe quel mode. Quand vous cliquez sur la vignette askSpoke dans Mes applications, si le mode Fournisseur de services est configuré, vous êtes redirigé vers la page de connexion de l’application pour lancer le flux de connexion, et si le mode Fournisseur d’identité est configuré, vous êtes automatiquement connecté à l’instance askSpoke pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).

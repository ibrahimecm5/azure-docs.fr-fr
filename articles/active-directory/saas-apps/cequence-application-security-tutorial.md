...
3. Vous pouvez utiliser le volet d’accès Microsoft. Quand vous cliquez sur la vignette Cequence Application Security Platform dans le volet d’accès, vous êtes redirigé vers l’URL de connexion Cequence Application Security Platform. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).

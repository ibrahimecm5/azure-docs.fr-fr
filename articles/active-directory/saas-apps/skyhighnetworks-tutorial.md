...
* MVISION Cloud Azure AD SSO Configuration prend en charge l'authentification unique initiée par **le fournisseur de services et le fournisseur d'identité**.

## <a name="add-mvision-cloud-azure-ad-sso-configuration-from-the-gallery"></a>Ajouter MVISION Cloud Azure AD SSO Configuration à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-mvision-cloud-azure-ad-sso-configuration"></a>Configurer et tester l'authentification unique Azure AD pour MVISION Cloud Azure AD SSO Configuration
...
Pour configurer et tester l'authentification unique Azure AD auprès de MVISION Cloud Azure AD SSO Configuration, procédez comme suit :
...
Dans cette section, vous allez autoriser B.Simon à utiliser l'authentification unique Azure en lui accordant l'accès à MVISION Cloud Azure AD SSO Configuration.

1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, puis **Toutes les applications**.
1. Dans la liste des applications, sélectionnez **MVISION Cloud Azure AD SSO Configuration**.
...
* Cliquez sur **Tester cette application** dans le portail Azure. Cette opération redirige vers l'URL de connexion à MVISION Cloud Azure AD SSO Configuration, d'où vous pouvez lancer le flux de connexion.  

* Accédez directement à l'URL de connexion à MVISION Cloud Azure AD SSO Configuration pour lancer le flux de connexion.

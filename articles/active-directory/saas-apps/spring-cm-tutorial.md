...
Dans ce tutoriel, vous allez apprendre à intégrer SpringCM à Azure Active Directory (Azure AD). Quand vous intégrez SpringCM à Azure AD, vous pouvez :

* Contrôler dans Azure AD qui a accès à SpringCM.
* Permettre à vos utilisateurs de se connecter automatiquement à SpringCM avec leur compte Azure AD.
...
## <a name="add-springcm-from-the-gallery"></a>Ajouter SpringCM depuis la galerie
...
1. Dans la section **Ajouter à partir de la galerie**, tapez **SpringCM** dans la zone de recherche.
1. Sélectionnez **SpringCM** dans le volet de résultats, puis ajoutez l’application. Patientez quelques secondes pendant que l’application est ajoutée à votre locataire.

## <a name="configure-and-test-azure-ad-sso-for-springcm"></a>Configurer et tester l’authentification unique Azure AD pour SpringCM

Configurez et testez l’authentification SSO Azure AD avec SpringCM à l’aide d’une utilisatrice de test appelée **B.Simon**. Pour que l’authentification unique fonctionne, vous devez établir un lien entre un utilisateur Azure AD et l’utilisateur SpringCM associé.

Pour configurer et tester l’authentification unique Azure AD avec SpringCM, effectuez les étapes suivantes :

1. **[Configurer l’authentification unique Azure AD](#configure-azure-ad-sso)** pour permettre à vos utilisateurs d’utiliser cette fonctionnalité.
    1. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec B. Simon.
    1. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à B. Simon d’utiliser l’authentification unique Azure AD.
1. **[Configurer l’authentification unique SpringCM](#configure-springcm-sso)** pour configurer les paramètres de l’authentification unique côté application.
    1. **[Créer un utilisateur de test SpringCM](#create-springcm-test-user)** pour avoir, dans SpringCM, un équivalent de B. Simon lié à la représentation Azure AD de l’utilisateur.
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **SpringCM**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
Dans cette section, vous allez autoriser B.Simon à utiliser l’authentification unique Azure en lui accordant l’accès à SpringCM.
...
## <a name="configure-springcm-sso"></a>Configurer l’authentification unique SpringCM
...
1. Dans le menu en haut, cliquez sur **GO TO**, sur **Preferences** puis, dans la section **Account Preferences**, cliquez sur **SAML SSO**.
    ...
    ![Authentification unique SAML](./media/spring-cm-tutorial/preferences.png "SAML SSO")

1. Dans la section Identity Provider Configuration, procédez comme suit :

    ![Configuration du fournisseur d’identité](./media/spring-cm-tutorial/configuration.png "Identity Provider Configuration")
...
1. Cliquez sur **GOTO** puis sur **ADDRESS BOOK**.
    ...
    ![Create User](./media/spring-cm-tutorial/user.png "Create User") (Créer un utilisateur)
...
* Cliquez sur **Tester cette application** dans le portail Azure. Une redirection est effectuée vers l’URL de connexion à SpringCM, où vous pouvez lancer le flux de connexion. 

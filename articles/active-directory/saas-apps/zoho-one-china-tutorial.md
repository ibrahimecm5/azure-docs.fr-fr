...
## <a name="add-zoho-one-china-from-the-gallery"></a>Ajouter Zoho One China à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-zoho-one-china"></a>Configurer et tester l’authentification unique (SSO) Azure AD pour Zoho One China
...
Pour configurer et tester l’authentification unique Azure AD avec Zoho One China, effectuez les étapes suivantes :
...
1. Sur le portail Azure, accédez à la page d’intégration de l’application **Zoho One China**, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
* Cliquez sur **Tester cette application** dans le portail Azure. Cette opération effectue une redirection vers l’URL de connexion à Zoho One China, d’où vous pouvez lancer le flux de connexion.  

* Accédez directement à l’URL de connexion à Zoho One China, puis lancez le flux de connexion.

#### <a name="idp-initiated"></a>Lancée par le fournisseur d’identité :

* Dans le portail Azure, cliquez sur **Tester cette application**. Vous êtes alors automatiquement connecté à l’instance Zoho One China pour laquelle vous avez configuré l’authentification unique. 

Vous pouvez aussi utiliser Mes applications de Microsoft pour tester l’application dans n’importe quel mode. Si, quand vous cliquez sur la vignette Zoho One China dans Mes applications, le mode Fournisseur de services est configuré, vous êtes redirigé vers la page de connexion de l’application pour lancer le flux de connexion. S’il s’agit du mode Fournisseur d’identité, vous êtes automatiquement connecté à l’instance Zoho One China pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).

## <a name="next-steps"></a>Étapes suivantes

 Une fois que vous avez configuré Zoho One China, vous pouvez appliquer le contrôle de session, qui protège l’exfiltration et l’infiltration des données sensibles de votre organisation en temps réel. Le contrôle de session est étendu à partir de l’accès conditionnel. [Découvrez comment appliquer un contrôle de session avec Microsoft Defender for Cloud Apps](/cloud-app-security/proxy-deployment-any-app).

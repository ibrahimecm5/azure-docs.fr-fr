...
* Kallidus prend en charge l’authentification unique lancée par l’**IdP** (fournisseur d’identité).

> [!NOTE]
> L’identificateur de cette application étant une valeur de chaîne fixe, une seule instance peut être configurée dans un locataire.

## <a name="add-kallidus-from-the-gallery"></a>Ajouter Kallidus à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-kallidus"></a>Configurer et tester l’authentification unique Azure AD pour Kallidus
...
Pour configurer et tester l’authentification unique Azure AD avec Kallidus, effectuez les étapes suivantes :

1. **[Configurer l’authentification unique Azure AD](#configure-azure-ad-sso)** pour permettre à vos utilisateurs d’utiliser cette fonctionnalité.
    1. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec B. Simon.
    1. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à B. Simon d’utiliser l’authentification unique Azure AD.
1. **[Configurer l’authentification unique Kallidus](#configure-kallidus-sso)** pour configurer les paramètres de l’authentification unique côté application.
    1. **[Créer un utilisateur de test Kallidus](#create-kallidus-test-user)** pour avoir un équivalent de B.Simon dans Kallidus lié à la représentation Azure AD associée.
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **Kallidus**, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
## <a name="configure-kallidus-sso"></a>Configurer l’authentification unique Kallidus
...
* Cliquez sur Tester cette application dans le portail Azure : vous devez être connecté automatiquement à l’instance de Kallidus pour laquelle vous avez configuré l’authentification unique.

* Vous pouvez utiliser Mes applications de Microsoft. Quand vous cliquez sur la vignette Kallidus dans Mes applications, vous devez être connecté automatiquement à l’application Kallidus pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).

## <a name="next-steps"></a>Étapes suivantes

Une fois que vous avez configuré Kallidus, vous pouvez appliquer le contrôle de session, qui protège contre l’exfiltration et l’infiltration des données sensibles de votre organisation en temps réel. Le contrôle de session est étendu à partir de l’accès conditionnel. [Découvrez comment appliquer un contrôle de session avec Microsoft Defender for Cloud Apps](/cloud-app-security/proxy-deployment-aad).

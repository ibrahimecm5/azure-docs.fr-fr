...
* KnowledgeOwl prend en charge l’authentification unique lancée par **le fournisseur de services et le fournisseur d’identité**.
* KnowledgeOwl prend en charge le provisionnement d’utilisateurs **Juste-à-temps**.

## <a name="add-knowledgeowl-from-the-gallery"></a>Ajouter KnowledgeOwl à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-knowledgeowl"></a>Configurer et tester l’authentification unique Azure AD pour KnowledgeOwl
...
Pour configurer et tester l’authentification unique Azure AD auprès de KnowledgeOwl, effectuez les étapes suivantes :
...
1. **[Configurer l’authentification unique KnowledgeOwl](#configure-knowledgeowl-sso)** pour configurer les paramètres de l’authentification unique côté application.
    1. **[Créer un utilisateur de test KnowledgeOwl](#create-knowledgeowl-test-user)** pour avoir un équivalent de B.Simon dans KnowledgeOwl, lié à la représentation Azure AD de l’utilisateur.
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **KnowledgeOwl**, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
1. Si vous souhaitez configurer l’application en **mode démarré par le fournisseur de services**, cliquez sur **Définir des URL supplémentaires**, puis effectuez les étapes suivantes :
    ...
    Dans la zone de texte **URL de connexion**, tapez l’URL en utilisant un des modèles suivants :

...
Dans ce tutoriel, vous allez apprendre à intégrer HappyFox dans Azure Active Directory (Azure AD). Quand vous intégrez HappyFox à Azure AD, vous pouvez :

* Contrôler qui a accès à HappyFox dans Azure AD.
* Permettre à vos utilisateurs de se connecter automatiquement à HappyFox avec leur compte Azure AD.
...
* Abonnement HappyFox pour lequel l’authentification unique (SSO) est activée.
...
## <a name="add-happyfox-from-the-gallery"></a>Ajout de HappyFox à partir de la galerie
...
1. Dans la section **Ajouter à partir de la galerie**, tapez **HappyFox** dans la zone de recherche.
1. Sélectionnez **HappyFox** dans le volet de résultats, puis ajoutez l’application. Patientez quelques secondes pendant que l’application est ajoutée à votre locataire.

## <a name="configure-and-test-azure-ad-sso-for-happyfox"></a>Configurer et tester Azure AD SSO pour HappyFox

Configurez et testez Azure AD SSO avec HappyFox pour un utilisateur de test nommé **B.Simon**. Pour que l’authentification unique fonctionne, vous devez établir un lien entre un utilisateur Azure AD et l’utilisateur associé dans HappyFox.

Pour configurer et tester Azure AD SSO avec HappyFox, effectuez les étapes suivantes :

1. **[Configurer l’authentification unique Azure AD](#configure-azure-ad-sso)** pour permettre à vos utilisateurs d’utiliser cette fonctionnalité.
    1. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec B. Simon.
    1. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à B. Simon d’utiliser l’authentification unique Azure AD.
1. **[Configurer l'authentification unique HappyFox](#configure-happyfox-sso)** pour configurer les paramètres de l'authentification unique côté application.
    1. **[Créer un utilisateur de test HappyFox](#create-happyfox-test-user)** pour avoir dans HappyFox un équivalent de B.Simon lié à la représentation Azure AD associée.
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **HappyFox**, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
Dans cette section, vous allez autoriser B.Simon à utiliser l’authentification unique Azure en lui accordant l’accès à HappyFox.

1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, puis **Toutes les applications**.
1. Dans la liste des applications, sélectionnez **HappyFox**.
...
## <a name="configure-happyfox-sso"></a>Configurer l’authentification unique HappyFox
...
4. Dans la section de configuration SAML, collez la valeur de l’**URL de connexion**, que vous avez copiée à partir du portail Azure, dans la zone de texte **SSO Target URL** (URL cible d’authentification unique).
    ...
    ![Capture d’écran montrant la section « SAML Configuration » avec la zone de texte « SSO Target URL » mise en évidence.](./media/happyfox-tutorial/target.png)
...
5. Ouvrez le certificat téléchargé à partir du portail Azure dans le Bloc-notes et collez son contenu dans la section **IdP Signature** (Signature IdP).
    ...
    ![Capture d’écran montrant la section « IdP Signature » mise en évidence.](./media/happyfox-tutorial/certificate.png)
...
1. Lorsque vous cliquez sur la mosaïque HappyFox dans Mes applications, la page de connexion de l’application HappyFox devrait apparaître. Vous devriez voir le bouton **SAML** sur la page de connexion.

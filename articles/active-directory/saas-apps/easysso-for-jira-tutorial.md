...
## <a name="add-easysso-for-jira-from-the-gallery"></a>Ajouter EasySSO for Jira à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-easysso-for-jira"></a>Configurer et tester l’authentification unique Azure AD pour EasySSO for Jira
...
Pour configurer et tester l’authentification unique Azure AD avec EasySSO for Jira, procédez comme suit :
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **EasySSO for Jira**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors automatiquement connecté à l’instance EasySSO for Jira pour laquelle vous avez configuré l’authentification unique. 

Vous pouvez aussi utiliser Mes applications de Microsoft pour tester l’application dans n’importe quel mode. Si, quand vous cliquez sur la vignette EasySSO for Jira dans Mes applications, le mode Fournisseur de services est configuré, vous êtes redirigé vers la page de connexion de l’application pour lancer le flux de connexion ; s’il s’agit du mode Fournisseur d’identité, vous êtes automatiquement connecté à l’instance EasySSO for Jira pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).

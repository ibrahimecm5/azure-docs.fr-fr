---
title: 'Tutoriel : Intégration de l’authentification unique Azure AD à Mail Luck!'
...
ms.locfileid: "132307457"
---
# <a name="tutorial-azure-ad-sso-integration-with-mail-luck"></a>Tutoriel : Intégration de l’authentification unique Azure AD à Mail Luck!
...
## <a name="add-mail-luck-from-the-gallery"></a>Ajouter Mail Luck! à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-mail-luck"></a>Configurer et tester l’authentification unique Azure AD pour Mail Luck!
...
Pour configurer et tester l’authentification unique Azure AD avec Mail Luck!, effectuez les étapes suivantes :
...
1. **[Configurer l’authentification unique Mail Luck!](#configure-mail-luck-sso)** pour configurer les paramètres de l’authentification unique côté application.
    1. **[Créer un utilisateur de Mail Luck!](#create-mail-luck-test-user)** pour avoir un équivalent de B.Simon dans Mail Luck! lié à la représentation Azure AD de l’utilisateur.
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **Mail Luck!**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
1. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    a. Dans la zone de texte **Identificateur (ID d’entité)** , saisissez une URL au format suivant : `https://manage<UNITID>.ml-sgw.jp/<TENANT_NAME>/saml/`

    b. Dans la zone de texte **URL de connexion**, saisissez une URL au format suivant : `https://manage<UNITID>.ml-sgw.jp/<TENANT_NAME>/saml/sign_in`

    > [!NOTE]
    > Il ne s’agit pas de valeurs réelles. Mettez à jour ces valeurs avec l’identificateur et l’URL de connexion réels. Contactez l’[ l’équipe du support technique d’Aha!](https://customer.nttpc.co.jp/cgi-bin/form/inquiry_index.cgi). Vous pouvez également consulter les modèles figurant à la section **Configuration SAML de base** dans le portail Azure.
...
* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL d’authentification de Mail Luck!, où vous pouvez lancer le flux de connexion. 

* Accédez directement à l’URL d’authentification de Mail Luck! pour lancer le flux de connexion.

* Vous pouvez utiliser Mes applications de Microsoft. Quand vous cliquez sur la vignette Mail Luck! dans Mes applications, vous êtes redirigé vers Mail Luck! URL de connexion. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Étapes suivantes

Une fois que vous avez configuré Mail Luck!, vous pouvez appliquer le contrôle de session, qui protège contre l’exfiltration et l’infiltration des données sensibles de votre organisation en temps réel. Le contrôle de session est étendu à partir de l’accès conditionnel. [Découvrez comment appliquer un contrôle de session avec Microsoft Defender for Cloud Apps](/cloud-app-security/proxy-deployment-aad).

...
Dans ce tutoriel, vous allez découvrir comment intégrer Blackboard Learn - Shibboleth à Azure Active Directory (Azure AD). Quand vous intégrez Blackboard Learn - Shibboleth à Azure AD, vous pouvez :

* Contrôler dans Azure AD qui a accès à Blackboard Learn - Shibboleth.
* Permettre à vos utilisateurs de se connecter automatiquement à Blackboard Learn - Shibboleth avec leur compte Azure AD.
...
1. Dans la section **Ajouter à partir de la galerie**, tapez **Blackboard Learn - Shibboleth** dans la zone de recherche.
1. Sélectionnez **Blackboard Learn - Shibboleth** dans le panneau de résultats, puis ajoutez l’application. Patientez quelques secondes pendant que l’application est ajoutée à votre locataire.

## <a name="configure-and-test-azure-ad-sso-for-blackboard-learn---shibboleth"></a>Configurer et tester l’authentification unique Azure AD pour Blackboard Learn - Shibboleth

Configurez et testez l’authentification unique Azure AD avec Blackboard Learn - Shibboleth pour un utilisateur de test appelé **B.Simon**. Pour que l’authentification unique fonctionne, vous devez établir un lien entre un utilisateur Azure AD et l’utilisateur associé dans Blackboard Learn - Shibboleth.

Pour configurer et tester l’authentification unique Azure AD avec Blackboard Learn - Shibboleth, effectuez les étapes suivantes :

1. **[Configurer l’authentification unique Azure AD](#configure-azure-ad-sso)** pour permettre à vos utilisateurs d’utiliser cette fonctionnalité.
    1. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec B. Simon.
    1. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à B. Simon d’utiliser l’authentification unique Azure AD.
1. **[Configurer l’authentification unique Blackboard Learn - Shibboleth](#configure-blackboard-learn---shibboleth-sso)** pour configurer les paramètres de l’authentification unique côté application.
...
1. Sur le portail Azure, dans la page d’intégration de l’application **Blackboard Learn - Shibboleth**, sélectionnez **Authentification unique**.
...
Dans cette section, vous allez autoriser B.Simon à utiliser l’authentification unique Azure en lui accordant l’accès à Blackboard Learn - Shibboleth.

1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, puis **Toutes les applications**.
1. Dans la liste des applications, sélectionnez **Blackboard Learn - Shibboleth**.
...
* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL de connexion à Blackboard Learn - Shibboleth, d’où vous pouvez lancer le flux de connexion. 

* Accédez directement à l’URL de connexion à Blackboard Learn - Shibboleth pour lancer le flux de connexion.

* Vous pouvez utiliser Mes applications de Microsoft. Quand vous cliquez sur la vignette Blackboard Learn - Shibboleth dans Mes applications, vous devez être connecté automatiquement à l’application Blackboard Learn - Shibboleth pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).

## <a name="next-steps"></a>Étapes suivantes

Après avoir configuré Blackboard Learn - Shibboleth, vous pouvez appliquer le contrôle de session, qui protège contre l’exfiltration et l’infiltration des données sensibles de votre organisation en temps réel. Le contrôle de session est étendu à partir de l’accès conditionnel. [Découvrez comment appliquer un contrôle de session avec Microsoft Defender for Cloud Apps](/cloud-app-security/proxy-deployment-any-app).

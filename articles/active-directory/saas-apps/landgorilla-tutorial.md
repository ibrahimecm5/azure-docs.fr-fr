---
title: 'Tutoriel : Intégration de l’authentification unique Azure AD à Land Gorilla'
...
ms.locfileid: "132317246"
---
# <a name="tutorial-azure-ad-sso-integration-with-land-gorilla"></a>Tutoriel : Intégration de l’authentification unique Azure AD à Land Gorilla
...
## <a name="add-land-gorilla-from-the-gallery"></a>Ajouter Land Gorilla à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-land-gorilla"></a>Configurer et tester l’authentification unique Azure AD pour Land Gorilla
...
Pour configurer et tester l’authentification unique Azure AD avec Land Gorilla, effectuez les étapes suivantes :

1. **[Configurer l’authentification unique Azure AD](#configure-azure-ad-sso)** pour permettre à vos utilisateurs d’utiliser cette fonctionnalité.
   1. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec B. Simon.
   1. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à B. Simon d’utiliser l’authentification unique Azure AD.
1. **[Configurer l’authentification unique de Land Gorilla](#configure-land-gorilla-sso)** pour configurer les paramètres de l’authentification unique côté application.
   1. **[Créer un utilisateur de test Land Gorilla](#create-land-gorilla-test-user)** pour avoir dans Land Gorilla un équivalent de B.Simon lié à la représentation Azure AD associée.
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **Land Gorilla**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
* Cliquez sur Tester cette application dans le portail Azure, ce qui devrait vous connecter automatiquement à l’application Land Gorilla pour laquelle vous avez configuré l’authentification unique.

* Vous pouvez utiliser Mes applications de Microsoft. Quand vous cliquez sur la vignette Land Gorilla dans Mes applications, vous devriez être connecté automatiquement à l’application Land Gorilla pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Étapes suivantes

Après avoir configuré Land Gorilla, vous pouvez appliquer le contrôle de session, qui protège contre l’exfiltration et l’infiltration des données sensibles de votre organisation en temps réel. Le contrôle de session est étendu à partir de l’accès conditionnel. [Découvrez comment appliquer un contrôle de session avec Microsoft Defender for Cloud Apps](/cloud-app-security/proxy-deployment-aad).

...
* Contrôler dans Azure AD qui a accès à WAN-Sign.
* Permettre à vos utilisateurs de se connecter automatiquement à WAN-Sign avec leur compte Azure AD.
...
* Un abonnement WAN-Sign pour lequel l’authentification unique est activée
...
Configurez et testez l’authentification unique Azure AD avec WAN-Sign à l’aide d’un utilisateur de test appelé **B.Simon**. Pour que l’authentification unique fonctionne, vous devez établir un lien entre un utilisateur Azure AD et l’utilisateur associé dans WAN-Sign.

Pour configurer et tester l’authentification unique Azure AD avec WAN-Sign, procédez comme suit :

1. **[Configurer l’authentification unique Azure AD](#configure-azure-ad-sso)** pour permettre à vos utilisateurs d’utiliser cette fonctionnalité.
    1. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec B. Simon.
    1. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à B. Simon d’utiliser l’authentification unique Azure AD.
1. **[Configurer l’authentification unique de WAN-Sign](#configure-wan-sign-sso)** pour configurer les paramètres de l’authentification unique côté application.
    1. **[Créer un utilisateur de test WAN-Sign](#create-wan-sign-test-user)** pour avoir un équivalent de B.Simon dans WAN-Sign lié à la représentation Azure AD de l’utilisateur.
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **WAN-Sign**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
1. Dans la section **Configurer WAN-Sign**, copiez les URL appropriées en fonction de vos besoins.
...
Dans cette section, vous allez autoriser B.Simon à utiliser l’authentification unique Azure en lui accordant l’accès à WAN-Sign.

1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, puis **Toutes les applications**.
1. Dans la liste des applications, sélectionnez **WAN-Sign**.
...
## <a name="configure-wan-sign-sso"></a>Configurer l’authentification unique de WAN-Sign

Pour configurer l’authentification unique côté **WAN-Sign**, vous devez envoyer le **certificat (Base64)** téléchargé et les URL appropriées, copiées à partir du portail Azure, à l’[équipe du support technique de WAN-Sign](mailto:wansign-help@wanbishi.ne.jp). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.

### <a name="create-wan-sign-test-user"></a>Créer un utilisateur de test WAN-Sign

Dans cette section, vous allez créer un utilisateur appelé Britta Simon dans WAN-Sign. Collaborez avec l’[équipe du support technique de WAN-Sign](mailto:wansign-help@wanbishi.ne.jp) pour ajouter des utilisateurs à la plateforme WAN-Sign. Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique.

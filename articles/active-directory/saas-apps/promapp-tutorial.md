...
## <a name="add-nintex-promapp-from-the-gallery"></a>Ajouter Nintex Promapp à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-nintex-promapp"></a>Configurer et tester l’authentification unique Azure AD pour Nintex Promapp
...
Pour configurer et tester l’authentification unique Azure AD avec Nintex Promapp, effectuez les étapes suivantes :
...
1. **[Configurer l’authentification unique Nintex Promapp](#configure-nintex-promapp-sso)** pour configurer les paramètres de l’authentification unique côté application.
    1. **[Créer un utilisateur de test Nintex Promapp](#create-nintex-promapp-test-user)** pour avoir un équivalent de B.Simon dans Nintex Promapp lié à la représentation Azure AD associée.
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **Nintex Promapp**, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
1. Dans la section **Configuration SAML de base**, si vous souhaitez configurer l’application en mode lancé par le **fournisseur d’identité**, effectuez les étapes suivantes :
    ...
    1. Dans la zone **URL de réponse**, tapez une URL au format suivant : `https://<DOMAIN_NAME>.promapp.com/TENANTNAME/saml/authenticate.aspx`

1. Si vous souhaitez configurer l’application en **mode démarré par le fournisseur de services**, cliquez sur **Définir des URL supplémentaires**, puis effectuez les étapes suivantes :

    Dans la zone **URL de connexion**, tapez une URL au format suivant : `https://<DOMAIN_NAME>.promapp.com/TENANTNAME/saml/authenticate`
...
2. Dans le menu en haut de la fenêtre, sélectionnez **Administrateur** :
    ...
    ![Sélectionnez Administrateur](./media/promapp-tutorial/admin.png)

3. Sélectionnez **Configurer** :

    ![Sélectionnez Configurer](./media/promapp-tutorial/configuration.png)

4. Dans la boîte de dialogue **Sécurité**, procédez comme suit.

    ![Boîte de dialogue Sécurité](./media/promapp-tutorial/certificate.png)
...
* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL de connexion à Nintex Promapp, d’où vous pouvez lancer le flux de connexion.  

* Accédez directement à l’URL de connexion à Nintex Promapp pour lancer le flux de connexion.

...
* Visibly prend en charge l’[attribution automatique d’utilisateurs](visibly-provisioning-tutorial.md).

## <a name="add-visibly-from-the-gallery"></a>Ajouter Visibly à partir de la galerie
...
Pour configurer et tester l’authentification unique Azure AD avec Visibly, effectuez les étapes suivantes :
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **Visibly**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
1. Effectuez les étapes ci-après dans la page suivante.
    ...
    b. Dans la zone de texte **SSO url** (URL SSO), collez la valeur de l’**URL de connexion** que vous avez copiée dans le portail Azure.
...
Visibly prend aussi en charge l’attribution automatique d’utilisateurs. Vous trouverez [ici](./visibly-provisioning-tutorial.md) plus d’informations sur la façon de configurer l’attribution automatique d’utilisateurs.

## <a name="test-sso"></a>Tester l’authentification unique (SSO) 

Dans cette section, vous allez tester votre configuration de l’authentification unique Azure AD avec les options suivantes. 

* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL d’authentification Visibly, d’où vous pouvez lancer le flux de connexion. 

* Accédez directement à l’URL d’authentification Visibly pour lancer le flux de connexion.

* Vous pouvez utiliser Mes applications de Microsoft. Quand vous cliquez sur la vignette Visibly dans Mes applications, vous êtes redirigé vers l’URL d’authentification Visibly. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).

...
## <a name="add-pipedrive-from-the-gallery"></a>Ajouter Pipedrive à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-pipedrive"></a>Configurer et tester l’authentification unique Azure AD pour Pipedrive
...
Pour configurer et tester l’authentification unique Azure AD avec Pipedrive, effectuez les étapes suivantes :
...
1. Dans le Portail Azure, dans la page d’intégration de l’application **Pipedrive**, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
1. Dans la section **SAML configuration for pipedrive** (Configuration de SAML pour Pipedrive), effectuez les étapes suivantes :
    ...
    ![Capture d’écran montrant la section « SAML configuration for Pipedrive » avec toutes les zones de texte mises en évidence](./media/pipedrive-tutorial/configure-3.png)
...
1. Faites défiler la page jusqu’à la section de l’entreprise et sélectionnez **Manage users** (Gérer les utilisateurs).
    ...
    ![Capture d’écran montrant « Manage users » sélectionné dans le menu « Company »](./media/pipedrive-tutorial/user-1.png)

1. Cliquez sur **Add Users** (Ajouter des utilisateurs).
    
    ![Capture d’écran montrant la page « Manage users » avec le bouton « Add users » sélectionné sur le côté droit](./media/pipedrive-tutorial/user-2.png)

1. Dans la section **Manage users**, effectuez les étapes suivantes :

    ![Configuration de Pipedrive](./media/pipedrive-tutorial/user-3.png)
...
* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL de connexion à Pipedrive, d’où vous pouvez lancer le flux de connexion.  

* Accédez directement à l’URL de connexion à Pipedrive, puis lancez le flux de connexion.

#### <a name="idp-initiated"></a>Lancée par le fournisseur d’identité :

* Dans le portail Azure, cliquez sur **Tester cette application**. Vous êtes alors automatiquement connecté à l’instance de Pipedrive pour laquelle vous avez configuré l’authentification unique. 

Vous pouvez aussi utiliser Mes applications de Microsoft pour tester l’application dans n’importe quel mode. Si, quand vous cliquez sur la vignette Pipedrive dans Mes applications, le mode Fournisseur de services est configuré, vous êtes redirigé vers la page de connexion de l’application pour lancer le flux de connexion ; s’il s’agit du mode Fournisseur d’identité, vous êtes automatiquement connecté à l’instance de Pipedrive pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).

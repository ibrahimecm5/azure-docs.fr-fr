---
title: 'Tutoriel : Intégration de l’authentification unique Azure AD à Korn Ferry 360'
...
ms.locfileid: "132317284"
---
# <a name="tutorial-azure-ad-sso-integration-with-korn-ferry-360"></a>Tutoriel : Intégration de l’authentification unique Azure AD à Korn Ferry 360
...
* Korn Ferry 360 prend en charge l’authentification SSO lancée par le **fournisseur de services**.

## <a name="add-korn-ferry-360-from-the-gallery"></a>Ajouter Korn Ferry 360 à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-korn-ferry-360"></a>Configurer et tester l’authentification unique Azure AD pour Korn Ferry 360
...
Pour configurer et tester l’authentification unique Azure AD avec Korn Ferry 360, effectuez les étapes suivantes :
...
1. **[Configurer l’authentification SSO Korn Ferry 360](#configure-korn-ferry-360-sso)** , pour configurer les paramètres d’authentification unique côté application.
    1. **[Créer un utilisateur de test Korn Ferry 360](#create-korn-ferry-360-test-user)** , pour avoir un équivalent de B.Simon dans Korn Ferry 360, qui soit lié à la représentation Azure AD de l’utilisateur.
...
1. Dans le portail Azure, accédez à la page d’intégration d’application **Korn Ferry 360**, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
1. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    a. Dans la zone de texte **Identificateur**, tapez une URL au format suivant : `https://<customidentifier>.kornferry.com/`

     b. Dans la zone de texte **URL de connexion**, tapez une URL au format suivant : `https://surveys.kornferry.com/<customidentifier>`.
...
* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL d’authentification de Korn Ferry 360, à partir de laquelle vous pouvez lancer le processus de connexion. 

* Accédez directement à l’URL d’authentification de Korn Ferry 360 pour lancer le processus de connexion.

* Vous pouvez utiliser Mes applications de Microsoft. Quand vous cliquez sur la vignette Korn Ferry 360 dans Mes applications, vous êtes redirigé vers l’URL d’authentification de Korn Ferry 360. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).

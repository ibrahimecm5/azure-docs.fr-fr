...
Dans le portail d’administration de RingCentral, sous Account Settings -> Directory Integrations, définissez le paramètre *Directory Provider* sur *SCIM*

---
title: 'Tutoriel : Intégration de l’authentification unique Azure AD à NegometrixPortal Single Sign On (SSO)'
...
ms.locfileid: "132294487"
---
# <a name="tutorial-azure-ad-sso-integration-with-negometrixportal-single-sign-on-sso"></a>Tutoriel : Intégration de l’authentification unique Azure AD à NegometrixPortal Single Sign On (SSO)
...
* NegometrixPortal Single Sign On (SSO) prend en charge l’authentification unique lancée par le **fournisseur de services**.

> [!NOTE]
> L’identificateur de cette application étant une valeur de chaîne fixe, une seule instance peut être configurée dans un locataire.

## <a name="add-negometrixportal-single-sign-on-sso-from-the-gallery"></a>Ajouter NegometrixPortal Single Sign On (SSO) à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-negometrixportal-single-sign-on-sso"></a>Configurer et tester l’authentification unique Azure AD pour NegometrixPortal Single Sign On (SSO)
...
Pour configurer et tester l’authentification unique Azure AD avec NegometrixPortal Single Sign On (SSO), effectuez les étapes suivantes :
...
1. **[Configurer l’authentification unique NegometrixPortal Single Sign On (SSO)](#configure-negometrixportal-single-sign-on-sso-sso)** pour configurer les paramètres de l’authentification unique côté application.
    1. **[Créer un utilisateur de test NegometrixPortal Single Sign On (SSO)](#create-negometrixportal-single-sign-on-sso-test-user)** pour avoir un équivalent de B.Simon dans NegometrixPortal Single Sign On (SSO) lié à la représentation Azure AD de l’utilisateur.
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **NegometrixPortal Single Sign On (SSO)**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL d’authentification de NegometrixPortal Single Sign On (SSO), à partir de laquelle vous pouvez lancer le processus de connexion. 

* Accédez directement à l’URL d’authentification de NegometrixPortal Single Sign On (SSO) pour lancer le processus de connexion.

* Vous pouvez utiliser Mes applications de Microsoft. Quand vous cliquez sur la vignette NegometrixPortal Single Sign On (SSO) dans Mes applications, vous êtes redirigé vers l’URL d’authentification de NegometrixPortal Single Sign On (SSO). Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Étapes suivantes

Après avoir configuré NegometrixPortal Single Sign On (SSO), vous pouvez appliquer le contrôle de session, qui protège contre l’exfiltration et l’infiltration des données sensibles de votre organisation en temps réel. Le contrôle de session est étendu à partir de l’accès conditionnel. [Découvrez comment appliquer un contrôle de session avec Microsoft Defender for Cloud Apps](/cloud-app-security/proxy-deployment-aad).

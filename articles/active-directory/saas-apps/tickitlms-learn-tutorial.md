...
## <a name="configure-and-test-azure-ad-sso-for-tickitlms-learn"></a>Configurer et tester l’authentification unique Azure AD pour TickitLMS Learn
...
Pour configurer et tester l’authentification unique Azure AD auprès de TickitLMS Learn, effectuez les étapes suivantes :
...
1. Dans le portail Azure, dans la page d’intégration de l’application **TickitLMS Learn**, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
1. En plus de ce qui précède, l’application TickitLMS Learn s’attend à ce que quelques attributs supplémentaires (présentés ci-dessous) soient repassés dans la réponse SAML. Ces attributs sont également préremplis, mais vous pouvez les examiner pour voir s’ils répondent à vos besoins.
   ...
   > [!NOTE]
   > TickitLMS Learn attend des rôles pour les utilisateurs affectés à l’application. Veuillez configurer ces rôles dans Azure AD pour pouvoir affecter les rôles appropriés aux utilisateurs. Pour comprendre comment configurer des rôles dans Azure AD, consultez [cette page](../develop/howto-add-app-roles-in-azure-ad-apps.md#app-roles-ui).
...
- Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL de connexion à TickitLMS Learn, à partir de laquelle vous pouvez lancer le flux de connexion.

- Accédez directement à l’URL de connexion à TickitLMS Learn pour y lancer le processus de connexion.

#### <a name="idp-initiated"></a>Lancée par le fournisseur d’identité :

- Dans le portail Azure, cliquez sur **Tester cette application**. Vous êtes alors automatiquement connecté à l’instance de TickitLMS Learn pour laquelle vous avez configuré l’authentification unique

Vous pouvez aussi utiliser Mes applications de Microsoft pour tester l’application dans n’importe quel mode. Si, quand vous cliquez sur la vignette TickitLMS Learn dans Mes applications, le mode Fournisseur de services est configuré, vous êtes redirigé vers la page de connexion de l’application pour lancer le flux de connexion ; s’il s’agit du mode Fournisseur d’identité, vous êtes automatiquement connecté à l’instance de TickitLMS Learn pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).

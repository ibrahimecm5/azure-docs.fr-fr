...
ms.locfileid: "132338266"
---
# <a name="tutorial-azure-active-directory-integration-with-degreed"></a>Didacticiel : Intégration d’Azure AD à Degreed

Dans ce tutoriel, vous allez découvrir comment intégrer Degreed à Azure Active Directory (Azure AD). Quand vous intégrez Degreed à Azure AD, vous pouvez :

* Contrôler dans Azure AD qui a accès à Degreed.
* Permettre à vos utilisateurs de se connecter automatiquement à Degreed avec leurs comptes Azure AD.
...
* Degreed prend en charge l’authentification unique initiée par le **fournisseur de services**.

* Degreed prend en charge le provisionnement d’utilisateurs **juste-à-temps**.

## <a name="add-degreed-from-the-gallery"></a>Ajouter Degreed à partir de la galerie
...
Configurez et testez l’authentification unique Azure AD auprès de Degreed pour un utilisateur de test nommé **B.Simon**. Pour que l’authentification unique fonctionne, vous devez établir un lien entre un utilisateur Azure AD et l’utilisateur associé dans Degreed.

Pour configurer et tester l’authentification unique Azure AD auprès de Degreed, procédez comme suit :

1. **[Configurer l’authentification unique Azure AD](#configure-azure-ad-sso)** pour permettre à vos utilisateurs d’utiliser cette fonctionnalité.
    1. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec B. Simon.
    1. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à B. Simon d’utiliser l’authentification unique Azure AD.
1. **[Configurer l’authentification unique Degreed](#configure-degreed-sso)** pour configurer les paramètres de l’authentification unique côté application.
    1. **[Créer un utilisateur de test Degreed](#create-degreed-test-user)** pour avoir un équivalent de B.Simon dans Degreed lié à la représentation Azure AD associée.
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **Degreed**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
Dans cette section, un utilisateur appelé B.Simon est créé dans Degreed. Degreed prend en charge le provisionnement d’utilisateurs juste-à-temps qui est activé par défaut. Vous n’avez aucune opération à effectuer dans cette section. S’il n’existe aucun utilisateur dans Degreed, un utilisateur est créé après l’authentification.
...
* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL de connexion à Degreed à partir de laquelle vous pouvez lancer le flux de connexion. 

* Accédez directement à l’URL de connexion à Degreed pour initier le flux de connexion.

* Vous pouvez utiliser Mes applications de Microsoft. Quand vous cliquez sur la vignette Degreed dans Mes applications, vous êtes redirigé vers l’URL de connexion à Degreed. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).

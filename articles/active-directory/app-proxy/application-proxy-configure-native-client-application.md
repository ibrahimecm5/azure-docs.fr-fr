---
title: Publication d’applications clientes natives – Azure Active Directory
description: Découvrez comment permettre à des applications clientes natives de communiquer avec le connecteur Proxy d’application Azure Active Directory pour assurer un accès à distance sécurisé à vos applications locales.
...
Publiez votre application proxy comme vous le feriez pour toute autre application et affectez des utilisateurs pour accéder à votre application. Pour plus d'informations, consultez [Publier des applications avec le proxy d'application](../app-proxy/application-proxy-add-on-premises-application.md).
...
Découvrez comment configurer [l’authentification unique SAML auprès des applications dans Azure Active Directory](../manage-apps/sso-options.md#choosing-a-single-sign-on-method).

---
title: Résoudre les problèmes de connexion à une application à partir du portail Mes applications
...
Voici quelques éléments pour vérifier si une application s’affiche ou non :
...
3. Exécutez `(Get-MgUserAppRoleAssignment -UserId "<user-id>" -PageSize 999).Count` pour déterminer le nombre actuel d’attributions de rôle d’application à l’utilisateur.

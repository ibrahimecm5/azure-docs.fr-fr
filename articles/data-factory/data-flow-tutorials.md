...
[Bien démarrer avec les flux de données de mappage dans Azure Data Factory](http://youtu.be/MFw7t_8tuV4)

## <a name="debugging-and-developing-mapping-data-flows"></a>Débogage et développement de flux de données de mappage

[Débogage et test de flux de données de mappage](https://www.youtube.com/watch?v=3ANxyvDGfjA).

[Exploration des données](https://www.youtube.com/watch?v=En1ztyh5GaA)
...
[Transformation de modification de ligne](https://www.youtube.com/watch?v=4ktoohwptmQ)
...
[Transformation d’union](http://youtu.be/_Et6mg1tEr8?hd=1)

[Transformation de suppression de tableau croisé dynamique](http://youtu.be/KFYkxcpB8b0?hd=1)

[Transformation de fenêtre](https://www.youtube.com/watch?v=m6zgbtY5AYQ)

[Transformation de filtre](https://youtu.be/OhbKDOXSfeE)

[Transformation de fractionnement conditionnel](http://youtu.be/W1lQHojhKZw?hd=1)

[Transformation d’existence](http://youtu.be/GS8JVgNBMfs?hd=1)
...
[Sortie vers l’activité suivante](http://youtu.be/r1m3Ya14qpE?hd=1)

## <a name="source-and-sink"></a>Source et récepteur

[Lecture et écriture de JSON](https://www.youtube.com/watch?v=yY5aB7Kdhjg)

[Fichiers texte aux formats Parquet et texte délimité](https://youtu.be/V_2a60j2Kjo)

[Connecteur CosmosDB](http://youtu.be/plp1etT2ftY?hd=1)

[Déduire les types de données dans des fichiers texte délimités](https://www.youtube.com/watch?v=nJjRzlFktlA)

[Lecture et écriture de fichiers partitionnés](https://www.youtube.com/watch?v=7Q-db4Qgc4M)

[Transformer et créer plusieurs tables SQL](https://www.youtube.com/watch?v=Sj15Yjwai1A)

[Partitionner vos fichiers dans le lac de données](https://youtu.be/VNWv-MvLQ_0)

[Modèle de chargement de l’entrepôt de données](https://www.youtube.com/watch?v=7mLqwtmeQFg)

[Options de sortie du fichier Data Lake](https://www.youtube.com/watch?v=NAPSbjvSQA8)

## <a name="optimizing-mapping-data-flows"></a>Optimisation des flux de données de mappage
...
[Modèle de données intermédiaires](https://youtu.be/mZLKdyoL3Mo)
...
[Dimensions à variation lente de type 1 : remplacer](http://youtu.be/Rz2zx5GRbrA)

[Dimensions à variation lente de type 2 : historique](http://youtu.be/123CptslKvU)

[Chargement de table de faits](http://youtu.be/ABG3X9pgFPQ)

[Transformer des données SQL Server localement avec le modèle de chargement de données Delta](https://youtu.be/IN-4v0e7UIs)

[Paramétrage](https://www.youtube.com/watch?v=vpuuQcFojt8)

[Nombre de lignes & lignes distinctes](https://youtu.be/ryYo8UFUgTI)

[Gestion des erreurs de troncation](http://youtu.be/sPpcSiKQz34)

[Routage intelligent des données](https://youtu.be/PIGw-Z-0upw)

[Masquage de données pour les données sensibles](https://www.youtube.com/watch?v=OFd4LeiTmfs)
...
[Expressions dynamiques en tant que paramètres](https://www.youtube.com/watch?v=q7W6J-DUuJY)

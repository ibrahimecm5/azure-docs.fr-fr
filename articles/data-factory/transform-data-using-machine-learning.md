...
## <a name="ml-studio-classic-batch-execution-activity"></a>Activité Batch Execution ML Studio (classique)
...
| linkedServiceName | Services liés au service lié ML Studio (classique) Pour en savoir plus sur ce service lié, consultez l’article [Services liés de calcul](compute-linked-services.md). | Oui      |

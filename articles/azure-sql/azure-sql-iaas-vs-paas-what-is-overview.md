...
| Bases de données comprenant jusqu’à 100 To. | Jusqu’à 16 To. | Instances SQL Server avec 256 To de stockage maximum. L’instance peut prendre en charge autant de bases de données que nécessaire. |

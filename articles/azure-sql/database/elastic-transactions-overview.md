...
## <a name="transactions-for-sql-database"></a>Transactions pour SQL Database

> [!IMPORTANT]
> Les transactions distribuées pour Azure SQL Database sont en préversion. 
...
* Pour les demandes de fonctionnalités, ajoutez-les au [forum de commentaires SQL Database](https://feedback.azure.com/forums/217321-sql-database/) ou au [forum SQL Managed Instance](https://feedback.azure.com/forums/915676-sql-managed-instance).

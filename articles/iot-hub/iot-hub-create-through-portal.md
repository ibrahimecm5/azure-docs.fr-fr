...
Pour plus d’informations sur les accès accordés par des autorisations spécifiques, consultez [Autorisations IoT Hub](./iot-hub-dev-guide-sas.md#access-control-and-permissions).

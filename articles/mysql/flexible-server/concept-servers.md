...
ms.locfileid: "131468211"
---
# <a name="server-concepts-in-azure-database-for-mysql-flexible-server"></a>Concepts de serveur dans le serveur flexible Azure Database pour MySQL

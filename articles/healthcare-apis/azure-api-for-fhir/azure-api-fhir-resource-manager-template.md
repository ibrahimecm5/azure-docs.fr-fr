...
4. Entrez un nouveau **Nom du service** et choisissez l’**Emplacement** de l’API Azure pour FHIR. L’emplacement peut être identique ou différent de la région du groupe de ressources.
   ...
   [![Déployez l’API Azure pour FHIR à l’aide du modèle ARM dans le portail Azure. ](media/fhir-resource-manager-template/deploy-azure-api-fhir.png) ](media/fhir-resource-manager-template/deploy-azure-api-fhir.png#lightbox)

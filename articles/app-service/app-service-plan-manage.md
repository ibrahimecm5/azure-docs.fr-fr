...
> [!TIP]
> Pour créer un plan dans un environnement App Service, vous pouvez le sélectionner dans la **Région** et suivre le reste des étapes, comme décrit ci-dessous.

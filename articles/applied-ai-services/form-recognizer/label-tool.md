---
title: 'Guide pratique : Analyser des documents, étiqueter des formulaires, entraîner un modèle et analyser des formulaires avec Form Recognizer'
titleSuffix: Azure Applied AI Services
description: Dans ce guide pratique, vous allez utiliser l’exemple d’outil Form Recognizer pour analyser des documents, des factures, des tickets de caisse, etc. Étiquetez et créez un modèle personnalisé pour extraire du texte, des tableaux, des marques de sélection, une structure et des paires clé/valeur de documents.
author: laujan
manager: nitinme
...
Essayez l’[**outil d’étiquetage des exemples Form Recognizer**](https://fott-2-1.azurewebsites.net/) en ligne :

> [!div class="nextstepaction"]
> [Essayer des modèles prédéfinis](https://fott-2-1.azurewebsites.net/)
...
> [!NOTE]
>
> Si vos données de stockage se trouvent derrière un réseau virtuel ou un pare-feu, vous devez déployer l’**outil d’étiquetage des exemples Form Recognizer** derrière votre réseau virtuel ou votre pare-feu, et lui accorder l’accès en créant une [identité managée affectée par le système](managed-identity-byos.md "L’identité managée Azure est un principal de service qui crée une identité Azure Active Directory (Azure AD) et des autorisations spécifiques pour les ressources managées Azure.").
...
> [!TIP]
> OCR Form Labeling Tool est également disponible en tant que projet open source sur GitHub. L’outil est une application web TypeScript créée à l’aide de React + Redux. Pour en savoir plus ou apporter votre contribution, consultez le dépôt [OCR Form Labeling Tool](https://github.com/microsoft/OCR-Form-Tools/blob/master/README.md#run-as-web-application). Pour essayer cet outil en ligne, accédez au [site web de l’outil d’étiquetage des exemples Form Recognizer](https://fott-2-1.azurewebsites.net/).
...
* `number`
  * default, `currency`
  * Mise en forme en tant que valeur à virgule flottante. 
  * Exemple : 1234,98 sur le document sera sous la forme 1234,98 sur la sortie
...
* `time`
* `integer`
  * Mise en forme en tant que valeur entière. 
  * Exemple : 1234,98 sur le document sera sous la forme 123498 sur la sortie
* `selectionMark`
...
:::image type="content" source="media/analyze.png" alt-text="Capture d’écran : fenêtre d’analyse de formulaire personnalisé":::

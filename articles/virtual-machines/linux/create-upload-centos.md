...
11. (Facultatif) Installez les pilotes pour les services d'intégration Linux (LIS).
    ...
    Vous pouvez également suivre le les instructions d’installation manuelle sur la [page de téléchargement des services d’intégration Linux (LIS)](https://www.microsoft.com/download/details.aspx?id=55106) et installez le package RPM sur votre machine virtuelle.
...
17. Cliquez sur **Action -> Arrêter** dans le Gestionnaire Hyper-V. Votre disque dur virtuel Linux est alors prêt pour [chargement dans Azure](/azure/virtual-machines/linux/upload-vhd#option-1-upload-a-vhd).
...
11. Installez l’agent Linux Azure et les dépendances pour les extensions de machine virtuelle Azure :
...
13. La configuration d’échange ne crée pas d’espace d’échange sur le disque du système d’exploitation.
...
14. Exécutez les commandes suivantes pour annuler le déploiement de la machine virtuelle et préparer son déploiement sur Azure :
     ...
     **Remarque :** si vous migrez une machine virtuelle spécifique et ne souhaitez pas créer d’image généralisée, ignorez l’étape de déprovisionnement.
...
15. Cliquez sur **Action -> Arrêter** dans le Gestionnaire Hyper-V. Votre disque dur virtuel Linux est alors prêt pour [chargement dans Azure](/azure/virtual-machines/linux/upload-vhd#option-1-upload-a-vhd).

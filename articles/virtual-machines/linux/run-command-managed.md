---
title: Exécuter des scripts sur une machine virtuelle Linux dans Azure à l’aide de commandes Run Command managées (préversion)
description: Cette rubrique explique comment exécuter des scripts au sein d’une machine virtuelle Linux Azure à l’aide de la fonctionnalité Run Command managée mise à jour.
services: automation
...
ms.locfileid: "131554808"
---
# <a name="preview-run-scripts-in-your-linux-vm-by-using-managed-run-commands"></a>Préversion : exécuter des scripts sur votre machine virtuelle Linux à l’aide de commandes Run Command managées
...
L’exemple suivant utilise la commande [az vm run-command](/cli/azure/vm/run-command) pour exécuter un script shell sur une machine virtuelle Linux Azure.

...
* [Article sur le contrôle d’accès en fonction du rôle (RBAC) Azure](role-based-access-control.md)

### <a name="august-2021"></a>Août 2021
* [Région de publication](luis-reference-regions.md#publishing-to-europe) Norvège Est.
* [Région de publication](luis-reference-regions.md#other-publishing-regions) USA Ouest 3.
...
* Application des pratiques DevOps avec LUIS
    ...
    * Procédures
        * [Appliquer DevOps au développement d’applications LUIS à l’aide de GitHub Actions](./luis-concept-devops-automation.md)

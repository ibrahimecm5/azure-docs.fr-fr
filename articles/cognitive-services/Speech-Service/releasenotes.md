...
## <a name="text-to-speech-2021-september-release"></a>Synthèse vocale - Version de septembre 2021
...
- **Amélioration générale de la prononciation** : Ardi dans la culture `id-ID`, Premwadee dans la culture `th-TH`, Christel dans la culture `da-DK`, HoaiMy et NamMinh dans la culture `vi-VN`.

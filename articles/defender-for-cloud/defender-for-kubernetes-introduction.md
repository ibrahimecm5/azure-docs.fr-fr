...
AKS est un service managé et, l’agent Log Analytics étant une extension managée par Microsoft, il est également pris en charge sur les clusters AKS. En revanche, si votre cluster est déployé sur un groupe de machines virtuelles identiques Azure Kubernetes Service, l’agent Log Analytics n’est pas pris en charge pour le moment.

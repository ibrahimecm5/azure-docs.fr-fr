---
title: Exemples de modèle Resource Manager pour les alertes de requête de journal
description: Exemples de modèle Azure Resource Manager pour déployer des alertes de requête de journal Azure Monitor.
ms.topic: sample
author: bwren
ms.author: bwren
ms.date: 07/12/2021
...
## <a name="template-for-all-resource-types-from-version-2021-08-01"></a>Modèle pour tous les types de ressources (à compter de la version 2021-08-01)
...
## <a name="number-of-results-template-up-to-version-2018-04-16"></a>Modèle de nombre de résultats (jusqu’à la version 2018-04-16)
L’exemple suivant crée une [règle d’alerte pour un nombre de résultats](../alerts/alerts-unified-log.md#count-of-the-results-table-rows).

### <a name="notes"></a>Notes

- Cet exemple comprend une [charge utile de webhook](../alerts/alerts-log-webhook.md). Si la règle d’alerte ne doit pas déclencher de webhook, supprimez l’élément **customWebhookPayload**.
...
## <a name="metric-measurement-template-up-to-version-2018-04-16"></a>Modèle de mesure des métriques (jusqu’à la version 2018-04-16)
L’exemple suivant crée une [règle d’alerte sur la mesure de métriques](../alerts/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value).

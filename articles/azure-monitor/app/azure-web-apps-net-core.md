...
Le modèle [Réduire les déploiements autonomes](/dotnet/core/deploying/trimming/trim-self-contained) n’est **pas pris en charge**. Optez plutôt pour une[instrumentation manuelle](./asp-net-core.md) via un code.
